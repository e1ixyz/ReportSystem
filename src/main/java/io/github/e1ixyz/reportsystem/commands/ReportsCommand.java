package io.github.e1ixyz.reportsystem.commands;
...
import io.github.e1ixyz.reportsystem.service.HtmlExporter;
import io.github.e1ixyz.reportsystem.service.ReportManager;
import io.github.e1ixyz.reportsystem.util.Pagination;
import io.github.e1ixyz.reportsystem.util.Text;
import io.github.e1ixyz.reportsystem.util.QuickActions;
import io.github.e1ixyz.reportsystem.util.TimeUtil;
    ...
    public void execute(Invocation inv) {
        ...
        switch (args[0].toLowerCase(Locale.ROOT)) {
            ...
            case "close" -> {
                ...
                if (!r.isOpen()) {
                    reply(src, msg("already-closed", "Report #%id% is already closed.")
            ...
            case "assign" -> {
                ...
                if (!r.isOpen()) {
                    reply(src, msg("reports-not-open", "<red>Report #%id% is not open. Use /reporthistory for closed reports.</red>")
                            .replace("%id%", String.valueOf(id)));
                    return;
                }
                String staff = args[2];
